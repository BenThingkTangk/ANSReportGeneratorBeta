...
function stubStudy(asciiHead: string): AnsStudy {
  ...
  return {
    ...
    ecg: { preview: [], durationSec: 0, quality: { snrDb: 0, motionFraction: 0, sentinelFraction: 0, leadOff: false, usable: false, unusableReasons: ["low_snr"], artifactFlags: [], warnings: [] } },
    baseline: p(60),
    deepBreathing: p(60),
    valsalva: p(60),
    standOrTilt: p(60),
