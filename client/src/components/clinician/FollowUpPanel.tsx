  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        <Clock className="w-4 h-4" style={{ color: "hsl(185 85% 50%)" }} />
      ...
      {followUp.monitorParameters.length > 0 && (
        <div>
          <p className="text-xs font-medium text-muted-foreground mb-2 uppercase tracking-wider">Monitor parameters:</p>
